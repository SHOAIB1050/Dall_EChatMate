...
class HpmePage extends StatefulWidget {
  const HpmePage({super.key});

  @override
  State<HpmePage> createState() => _HpmePageState();
}

class _HpmePageState extends State<HpmePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: BounceInDown(
          child: const Text('DALL-E ChatMate',style: TextStyle(fontWeight: FontWeight.bold, fontFamily: 'Cera Pro'),),
        ),
                ...
                children: [
                  SlideInLeft(
                    ...
                    child: const FeatureBox(
                        ...
                        HeaderText: 'ChatGPT',
                        DescriptionText:
                            'A Smart way to say Organized and Informed with ChatGPT.'),
                  ),
                  SlideInLeft(
                    ...
                    child: const FeatureBox(
                        ...
                        HeaderText: 'Dell-E',
                        DescriptionText:
                            'Get Inspired and Stay Creative with your Persnoal Assistant Powered by Dall-E.'),
                  ),
                  SlideInLeft(
